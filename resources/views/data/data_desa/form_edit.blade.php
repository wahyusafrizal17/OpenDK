<div class="form-group">
    ...
    <div class="col-md-2 col-sm-2 col-xs-12">
        <input id="desa_id" class="form-control" placeholder="00.00.00.0000" name="desa_id" type="text" value="{{ $desa->desa_id }}" required readonly/>
    </div>
    <div class="col-md-4 col-sm-4 col-xs-12">
        <select class="form-control" id="list_desa" name="nama" required>
